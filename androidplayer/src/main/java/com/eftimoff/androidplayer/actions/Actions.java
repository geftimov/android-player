...
public class Actions {
    ...
    public static CurveAction curve(final View view, final float x, final float y, final int degree) {
        ...
        final float heightOfTriangle = getHeightOfTriangle(base / 2, degree);
        ...
        return CurveAction.newControlPointsCurveAction(view).translationX(x).translationY(y).controlPoint1X(xCoordinate).controlPoint1Y(yCoordinate).controlPoint2X(xCoordinate).controlPoint2Y(yCoordinate).build();
    }
